...
/* GET/product/add*/
router.get('/products/add', productCtrl.addProduct);

/* GET/:product */
router.get('/products/:slug', productCtrl.getProduct);

/* GET/:product/edit */
router.get('/products/:slug/edit', productCtrl.editProduct);
...
/* PUT/:product */
router.post('/products/:slug/edit', upload.array('images', 12), productCtrl.updateProduct);
